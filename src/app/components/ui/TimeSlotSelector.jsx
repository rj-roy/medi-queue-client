...
const TimeSlotSelector = ({ hourlyFee = 0, timeSlot = [], institutionExperience, tutorName, bookingSubmiteAction }) => {
    ...
    const handleBooking = async () => {
        ...
        if (getBooking) {
            // const isBooked = getBooking.find((b) => {
        ...
        // const userd = getBooking.find(b=>b?.whoBooked?.id === session?.data?.user.id)
        // console.log(userd);
        // if(userd){
        //     console.log("already booked");
        //     return;
        ...
        // console.log(whoBooked);

        // const isBooked = getBooking.find(
        //     booking => booking?.whoBooked.id === whoBooked.id
        // );
